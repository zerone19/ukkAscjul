				...
				<div class="col-sm-10 col-md-8 col-lg-6 col-xl-5 mx-auto d-table h-100">
					<div class="d-table-cell align-middle">
						...
						<div class="text-center mt-4">
							<h1 class="h2" style="color:#FFFFFF"><b>Selamat Datang</b></h1>
								...
								<div class="m-sm-3">
                                    ...
                                    if(isset($_POST['login'])) {
                                        ...
                                        if($cek > 0){
                                            ...
                                            echo '<script>alert("Selamat Datang, Login Anda Telah Berhasil"); location.href="index.php";</script>';
                                        }else{
									...
									<form method="post">
										...
										<div class="d-grid gap-2 mt-3">
											<button class="btn btn-lg btn-success" type="submit" name="login" value="login">Login</button>
										</div>
									</form>
								</div>
							</div>
						...
						<div class="text-center mb-3" style="color:#FFFFFF">
							<b>Belum Punya Akun?</b><a href="register.php" style="color:#00D4FF">  <b>Registrasi</b></a>
						</div>
					</div>
				</div>
			</div>
